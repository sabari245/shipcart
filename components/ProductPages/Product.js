...
import Trending_Products from "./Trending_Product";

function Product1({ url, name, price, id }) {
  ...
  useEffect(() => {
    const q = query(collection(db, "products", id, "comments"));
  ...
  const shareComment = async () => {
    if (comment) {
      // TODO: sanitize comment and check for previous comments
      const docData = {
      ...
      await setDoc(doc(db, "products", id, "comments", user.uid), docData);
      setComment("");
            ...
            <div>
              ...
              <div class="space-y-6">
                <p class="text-base text-gray-900">
                  ...
                  nisi, eu aliquet nisl nisl eget nunc.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              {added && (
                <>
                  ...
                  ></textarea>
                  <button
                    className="bg-blue-600 px-5 py-3 text-white rounded-lg w-1/4 text-center mt-8"
              ...
              <p className="mt-16 font-bold">Reviews</p>
            </div>
